      ...
      <div className="mb-6 flex justify-between items-center flex-wrap">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`px - 3 py - 1 rounded - md text - sm font - medium ${filter === 'all' ? 'bg-primary-100 text-primary-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              }`}
          >
            All
          </button>
          <button
            ...
            className={`px - 3 py - 1 rounded - md text - sm font - medium ${filter === 'pending' ? 'bg-yellow-100 text-yellow-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              } `}
          >
            Pending
          </button>
          <button
            ...
            className={`px - 3 py - 1 rounded - md text - sm font - medium ${filter === 'verified' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              } `}
          >
            Verified
          </button>
          <button
            ...
            className={`px - 3 py - 1 rounded - md text - sm font - medium ${filter === 'resolved' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
              } `}
          >
            Resolved
          </button>
